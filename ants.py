...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 7
                # if self.ant.container==True or insect.container==True:
                #     self.ant=insect

                if self.ant.can_contain(insect)==True:
                   #self.ant=self.ant
    ...
    def remove_insect(self, insect):
        ...
        insect.place = None
        if type(insect) is QueenAnt:
            if insect.Flag==False:
                insect.place=None
                #print("impostor")
            else:
                insect.place=self
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while (i!=self.max_range and next_place!=hive) and next_place!=None:
            if next_place.bees==[]:
                 next_place=next_place.entrance
                 i+=1
            else:
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor<=0:
            ...
            for i in range(len(lst)):
                Insect.reduce_armor(lst[i],self.damage)
            self.place.remove_insect(self)
...
# BEGIN Problem 5A
class WallAnt(Ant):
    """A wall ant which does nothing each turn . It is useful because"""
    """it has large armor value"""
    food_cost=4
    name='Wall'
    implemented=True
...
class NinjaAnt(Ant):
    ...
    def action(self, colony):
        # BEGIN Problem 6A
        local_bees=list(self.place.bees)
        if local_bees!=[]:
            for i in range(len(local_bees)):
                #self.place.bees[i].armor-=self.damage
                Insect.reduce_armor(local_bees[i],self.damage)
        # END Problem 6A
...
class TankAnt(BodyguardAnt):
    ...
    def action(self, colony):
        ...
        for i in range(len(bees_lst)):
            Insect.reduce_armor(bees_lst[i],self.damage)
        BodyguardAnt.action(self,colony)

            #print(i.armor)
            # if i.armor<=0:
            #     self.place.remove_insect(i)
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, colony):
        ...
        if self.Flag==False:
            ...
            while prev_place!=None:
                if prev_place.ant!=None:
                    if prev_place.ant not in self.Ants:
                        prev_place.ant.damage=prev_place.ant.damage*2
                        self.Ants=self.Ants+[prev_place.ant]
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 9
        self.armor-=amount
        if self.Flag==True and self.armor==0:
            bees_win()
        "*** REPLACE THIS LINE ***"
        # END Problem 9
